    ...
    <section className="w-full min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-12 py-10">
      <div className="w-full max-w-7xl">
        ...
        >
          ...
          {/* Image 3 (responsive tall layout) */}
          <div
            className="
          ...
          <div
            ...
            "
          >
            {/* For small screens → show text INSIDE box */}
            <div className="block lg:hidden text-center px-4">
              <h1 className="text-4xl sm:text-5xl font-bold text-white tracking-tight">
                PORTFOLIO
              </h1>
              <h2 className="text-5xl sm:text-7xl font-extrabold text-white leading-none">
                HIGHLIGHTS
              </h2>
            </div>

            {/* For large screens → position text OVERLAY */}
            <div className="hidden lg:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center">
              <h1 className="text-5xl md:text-7xl font-bold text-white tracking-tight">
                PORTFOLIO
              </h1>
              <h2 className="text-7xl md:text-9xl font-extrabold text-white leading-none">
                HIGHLIGHTS
              </h2>
            </div>
          </div>
