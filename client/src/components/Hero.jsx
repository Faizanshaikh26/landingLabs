...
export default function HeroSection() {
  return (
    ...
    <section className="  text-primaryText pt-20 lg:pt-32">
      ...
      <div className="absolute  md:right-[340px] top-[240px] md:top-[290px]  w-[70%] md:w-[30%] p-1 mx-auto bg-[#111] md:p-3 rounded-xl lg:shadow-xl z-20 text-center lg:border border-gray-700 ">
        <p className="text-[8px] md:text-[10px] lg:text-sm leading-relaxed text-gray-200">
          With over 3 years in digital marketing and IT, our expert team brings deep domain knowledge, proven frameworks, and technical brilliance —{" "}
      ...
      <div className="lg:max-w-7xl w-full mx-auto px-4 py-4 lg:py-16 relative">
        {/* Background Image */}
        <div
          className="relative w-full h-[400px] bg-cover bg-center rounded-[5px] md:rounded-3xl overflow-hidden"
