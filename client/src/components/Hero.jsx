...
//           <button className="border border-black px-6 py-2 rounded-full font-semibold text-sm hover:bg-black hover:text-white transition">
//             LEARN HOW WE DO IT
//           </button>
//         </div>
//       </div>
...
export default function HeroSection() {
  ...
  <div className="lg:max-w-7xl w-full mx-auto px-4 py-4 lg:py-16 relative">
    ...
    >
      ...
      {/* Floating Text Box */}
      <div className="absolute top-[-10px] lg:top-[-30px] right-[-90px] bg-transparent lg:right-[-100px] transform -translate-x-1/2 w-[80%] lg:w-[45%] lg:bg-[#111] p-6 rounded-xl lg:shadow-xl z-20 text-center lg:border border-gray-700">
        <p className="text-[10px] lg:text-sm leading-relaxed text-gray-200">
          With over 3 years in digital marketing and IT, our expert team brings deep domain knowledge, proven frameworks, and technical brilliance —{" "}
