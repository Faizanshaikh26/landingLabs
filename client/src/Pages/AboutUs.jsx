    ...
    width: fit-content;
      ...
      `}</style>
        ...
        <div className="max-w-screen-xl mx-auto px-4 text-[#EAEAEA]">
          ...
          <ScrollSlideInFromRight>
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 rounded-md border border-gray-200 shadow-sm overflow-hidden">
              <div
                className="absolute inset-0 bg-cover bg-center bg-no-repeat filter blur-sm scale-105"
              style={{ backgroundImage: `url(${AboutBanner})`, zIndex: 0 }}
          ...
          <div className="py-16">
            ...
            <motion.div
              className="bg-[#100604] text-black max-w-7xl mx-auto px-4 py-8 rounded-lg sm:px-6 sm:py-12"
              variants={fadeUpVariant}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.2 }}
        ...
        >
          <p className="text-orange-500 font-semibold text-lg mb-2">2023 – 2025</p>
          <h2 className="text-[#DDD] text-light text-2xl md:text-3xl font-bold mb-6">
            We collaborate with:
          </h2>
          <ul className="space-y-3 text-[#DDD] text-base leading-relaxed">
            <li>Ambitious startups ready to launch.</li>
