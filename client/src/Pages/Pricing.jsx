...
>
      ...
      {/* FAQ Section */}
      <section className=" py-10 md:py-20 sm:px-6 md:px-8 px-4 bg-white text-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-800 rounded-full border border-gray-700">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
      ...
      <section className="py-10 md:py-20 px-4 bg-white text-black">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 p-2">
            {features.map((feature, index) => {
              const Icon = feature.icon
              return (
                <motion.div
