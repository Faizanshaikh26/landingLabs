...
//                 <span className="text-primaryText text-sm font-medium">Who We Are</span>
//               </div>
//             </div>
...
//             {/* Description */}
//             <p className="text-secondaryTexttext-base leading-relaxed">
...
//                 <div className="text-4xl lg:text-5xl font-bold text-primaryText">99.9%</div>
//                 <div className="flex-1 pt-2">
//                   <p className="text-secondaryTexttext-base">
...
//               {/* 500+ stat */}
//               <div className="flex items-start space-x-6">
//                 <div className="text-4xl lg:text-5xl font-bold text-primaryText">500+</div>
//                 <div className="flex-1 pt-2">
//                   <p className="text-secondaryTexttext-base">
