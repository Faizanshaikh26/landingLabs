...
//         <h3 className="text-white text-xl font-semibold mb-3">Service Category</h3>
//         <div className="space-y-2">
//           {serviceCategories.map((service) => (
//             <a
//               href={service.link}
//               key={service.id}
//               className="flex items-center justify-between py-3 px-4 rounded-xl hover:bg-slate-700/30 transition-colors cursor-pointer group"
//             >
...
//           </svg>
//         </div>
//         <h3 className="text-white text-xl font-semibold mb-4">How Can We Help</h3>
