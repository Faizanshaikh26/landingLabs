...
export default function SkincareDetails() {
  ...
  Skincare is more than routine—it’s self-care and confidence. Every product tells 
  a story of nourishment, protection, and renewal, designed to help skin look and 
  feel its best. The focus is on combining nature-inspired ingredients with modern 
  science to create formulas that deliver visible results. Through authentic 
  storytelling, educational content, and compelling campaigns, the goal is to build 
  trust, inspire healthier choices, and empower people to embrace their natural glow 
  with confidence.
</p>
                ...
                <div className="bg-white px-6 md:px-16 py-12 max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <img src={image7} alt="Bottom 3" className="rounded-lg shadow-md hover:scale-105 transition-transform duration-300" />
                        <img src={image6} alt="Bottom 4" className="rounded-lg shadow-md hover:scale-105 transition-transform duration-300 " />
                    </div>
                </div>
                ...
                <div className="mx-auto max-w-4xl py-10">
                    <img src={image7} className="rounded-xl shadow-md mx-auto w-full h-[80vh]" />
                </div>
                ...
                <div className="bg-white px-6 md:px-16 py-12 max-w-7xl mx-auto">
                    <div className="mb-16 flex justify-center">
                        <img src={image12} alt="Center Showcase" className="rounded-xl shadow-md mx-auto w-full h-[80vh]  " />
                    </div>
<div className="grid grid-cols-2 md:grid-cols-4 gap-6">
